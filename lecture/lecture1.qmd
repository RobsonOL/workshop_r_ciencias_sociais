...
-   [**Slides**](https://mine-cetinkaya-rundel.github.io/tidyperspective/talks/dagstat-2022.html#/title-slide){style="color: blue"}

-   [**Blogs**](www.robsonolima.com.br){style="color: blue"}

-   [**Relatórios**](https://housingprofiles.pschousing.org/profile/#Ashford){style="color: blue"}

-   [**Sites dinâmicos**](https://shiny.rstudio.com/gallery/){style="color: blue"}
